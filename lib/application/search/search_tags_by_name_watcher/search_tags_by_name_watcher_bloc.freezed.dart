...
mixin _$SearchTagsByNameWatcherEvent {
  ...
  $SearchTagsByNameWatcherEventCopyWith<SearchTagsByNameWatcherEvent> get copyWith;
}
...
class _$SearchTagsByNameWatcherStateTearOff {
  ...
  _SearchSuccess searchSuccess(Set<Tag> tagsFound) {
...
mixin _$SearchTagsByNameWatcherState {
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result searchSuccess(Set<Tag> tagsFound),
