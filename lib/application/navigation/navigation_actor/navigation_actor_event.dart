...
class NavigationActorEvent with _$NavigationActorEvent {
  ...
  const factory NavigationActorEvent.experienceNavigationTapped(
    Option<Experience> experienceOption,
  ) = _ExperienceNavigationTapped;
  ...
  const factory NavigationActorEvent.notificationsTapped() =
      _NotificationsTapped;
}
