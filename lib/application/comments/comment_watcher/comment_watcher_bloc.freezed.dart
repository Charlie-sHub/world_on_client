...
abstract class _$LoadExperienceCommentsCopyWith<$Res> implements $CommentWatcherEventCopyWith<$Res> {
  factory _$LoadExperienceCommentsCopyWith(_LoadExperienceComments value, $Res Function(_LoadExperienceComments) then) = __$LoadExperienceCommentsCopyWithImpl<$Res>;

  @override
  $Res call({int experienceId});
}

class __$LoadExperienceCommentsCopyWithImpl<$Res> extends _$CommentWatcherEventCopyWithImpl<$Res> implements _$LoadExperienceCommentsCopyWith<$Res> {
  __$LoadExperienceCommentsCopyWithImpl(_LoadExperienceComments _value, $Res Function(_LoadExperienceComments) _then) : super(_value, (v) => _then(v as _LoadExperienceComments));
...
class _$_LoadExperienceComments implements _LoadExperienceComments {
  const _$_LoadExperienceComments(this.experienceId) : assert(experienceId != null);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _LoadExperienceComments && (identical(other.experienceId, experienceId) || const DeepCollectionEquality().equals(other.experienceId, experienceId)));
  }
  ...
  @override
  _$LoadExperienceCommentsCopyWith<_LoadExperienceComments> get copyWith => __$LoadExperienceCommentsCopyWithImpl<_LoadExperienceComments>(this, _$identity);
...
abstract class _LoadExperienceComments implements CommentWatcherEvent {
  const factory _LoadExperienceComments(int experienceId) = _$_LoadExperienceComments;
...
class __$LoadingCopyWithImpl<$Res> extends _$CommentWatcherStateCopyWithImpl<$Res> implements _$LoadingCopyWith<$Res> {
