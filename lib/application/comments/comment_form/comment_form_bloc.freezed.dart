...
class __$InitializeCopyWithImpl<$Res> extends _$CommentFormEventCopyWithImpl<$Res> implements _$InitializeCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_Initialize(
      commentOption: commentOption == freezed ? _value.commentOption : commentOption as Option<Comment>,
...
abstract class _Initialize implements CommentFormEvent {
  const factory _Initialize({@required Option<Comment> commentOption, @required int experienceId}) = _$_Initialize;
...
abstract class _$ContentChangeCopyWith<$Res> {
  factory _$ContentChangeCopyWith(_ContentChange value, $Res Function(_ContentChange) then) = __$ContentChangeCopyWithImpl<$Res>;

  $Res call({String content});
}

class __$ContentChangeCopyWithImpl<$Res> extends _$CommentFormEventCopyWithImpl<$Res> implements _$ContentChangeCopyWith<$Res> {
  __$ContentChangeCopyWithImpl(_ContentChange _value, $Res Function(_ContentChange) _then) : super(_value, (v) => _then(v as _ContentChange));
...
class _$_ContentChange implements _ContentChange {
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _ContentChange && (identical(other.content, content) || const DeepCollectionEquality().equals(other.content, content)));
  }
  ...
  @override
  _$ContentChangeCopyWith<_ContentChange> get copyWith => __$ContentChangeCopyWithImpl<_ContentChange>(this, _$identity);
...
class __$SubmitCopyWithImpl<$Res> extends _$CommentFormEventCopyWithImpl<$Res> implements _$SubmitCopyWith<$Res> {
...
abstract class $CommentFormStateCopyWith<$Res> {
  ...
  $Res call({Comment comment, int experienceId, bool showErrorMessages, bool isEditing, bool isSubmitting, Option<Either<Failure, Unit>> failureOrSuccessOption});
...
class _$_CommentFormState implements _CommentFormState {
  const _$_CommentFormState(
      {@required this.comment, @required this.experienceId, @required this.showErrorMessages, @required this.isEditing, @required this.isSubmitting, @required this.failureOrSuccessOption})
      : assert(comment != null),
        assert(experienceId != null),
