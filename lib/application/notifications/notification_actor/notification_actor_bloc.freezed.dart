...
abstract class _$DeleteCopyWith<$Res> implements $NotificationActorEventCopyWith<$Res> {
...
class __$DeleteCopyWithImpl<$Res> extends _$NotificationActorEventCopyWithImpl<$Res> implements _$DeleteCopyWith<$Res> {
...
class _$_Delete implements _Delete {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _Delete && (identical(other.notification, notification) || const DeepCollectionEquality().equals(other.notification, notification)));
  }
...
abstract class _$CheckCopyWith<$Res> implements $NotificationActorEventCopyWith<$Res> {
  factory _$CheckCopyWith(_Check value, $Res Function(_Check) then) = __$CheckCopyWithImpl<$Res>;
...
class __$CheckCopyWithImpl<$Res> extends _$NotificationActorEventCopyWithImpl<$Res> implements _$CheckCopyWith<$Res> {
  __$CheckCopyWithImpl(_Check _value, $Res Function(_Check) _then) : super(_value, (v) => _then(v as _Check));
...
class _$_Check implements _Check {
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _Check && (identical(other.notification, notification) || const DeepCollectionEquality().equals(other.notification, notification)));
  }
