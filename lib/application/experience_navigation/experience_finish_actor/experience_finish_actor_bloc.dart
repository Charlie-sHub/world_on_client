...
@injectable
class ExperienceFinishActorBloc
    extends Bloc<ExperienceFinishActorEvent, ExperienceFinishActorState> {
  ExperienceFinishActorBloc()
      : super(const ExperienceFinishActorState.initial()) {
    on<_FinishedExperience>(_onFinishedExperience);
  }

  FutureOr<void> _onFinishedExperience(
    _FinishedExperience event,
    Emitter emit,
  ) async {
