...
class _$ProfileEditingFormStateTearOff {
  ...
  _ProfileEditingFormState call({@required User user, @required bool showErrorMessages, @required bool isSubmitting, @required Option<Either<Failure, Unit>> failureOrSuccessOption}) {
...
class _$_ProfileEditingFormState implements _ProfileEditingFormState {
  const _$_ProfileEditingFormState({@required this.user, @required this.showErrorMessages, @required this.isSubmitting, @required this.failureOrSuccessOption})
      : assert(user != null),
...
abstract class _ProfileEditingFormState implements ProfileEditingFormState {
  const factory _ProfileEditingFormState({@required User user, @required bool showErrorMessages, @required bool isSubmitting, @required Option<Either<Failure, Unit>> failureOrSuccessOption}) =
