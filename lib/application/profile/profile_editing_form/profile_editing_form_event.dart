...
class ProfileEditingFormEvent with _$ProfileEditingFormEvent {
  const factory ProfileEditingFormEvent.initialized(
    User userToEdit,
  ) = _Initialized;
  ...
  const factory ProfileEditingFormEvent.passwordChanged(
    String password,
  ) = _PasswordChanged;

  const factory ProfileEditingFormEvent.passwordConfirmationChanged(
  ...
  const factory ProfileEditingFormEvent.birthdayChanged(
    DateTime birthday,
  ) = _BirthdayChanged;

  const factory ProfileEditingFormEvent.descriptionChanged(
    String description,
  ) = _DescriptionChanged;

  const factory ProfileEditingFormEvent.interestsChanged(
    KtSet<Tag> interests,
  ) = _InterestsChanged;
