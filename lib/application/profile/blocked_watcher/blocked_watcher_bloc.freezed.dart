...
mixin _$BlockedWatcherEvent {
  ...
  $BlockedWatcherEventCopyWith<BlockedWatcherEvent> get copyWith;
}
...
abstract class _$WatchBlockedUsersStartedCopyWith<$Res> implements $BlockedWatcherEventCopyWith<$Res> {
...
class _$BlockedWatcherStateTearOff {
  ...
  _LoadSuccess loadSuccess(Set<User> blockedUsers) {
    return _LoadSuccess(
      blockedUsers,
    );
  }
...
mixin _$BlockedWatcherState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result loadSuccess(Set<User> blockedUsers),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result loadSuccess(Set<User> blockedUsers),
...
abstract class _$LoadSuccessCopyWith<$Res> {
  ...
  $Res call({Set<User> blockedUsers});
}
...
class __$LoadSuccessCopyWithImpl<$Res> extends _$BlockedWatcherStateCopyWithImpl<$Res> implements _$LoadSuccessCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_LoadSuccess(
      blockedUsers == freezed ? _value.blockedUsers : blockedUsers as Set<User>,
    ));
  }
}
...
abstract class _LoadSuccess implements BlockedWatcherState {
  const factory _LoadSuccess(Set<User> blockedUsers) = _$_LoadSuccess;
