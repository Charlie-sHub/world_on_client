...
_$_ExperienceDto _$$_ExperienceDtoFromJson(Map<String, dynamic> json) =>
    _$_ExperienceDto(
      ...
      comments: (json['comments'] as List<dynamic>)
          ...
          .toSet(),
      likedBy:
          (json['likedBy'] as List<dynamic>).map((e) => e as String).toSet(),
...
Map<String, dynamic> _$$_ExperienceDtoToJson(_$_ExperienceDto instance) =>
    <String, dynamic>{
      'id': instance.id,
