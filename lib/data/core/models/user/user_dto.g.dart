...
_$_UserDto _$_$_UserDtoFromJson(Map<String, dynamic> json) {
  return _$_UserDto(
    ...
    devices: (json['devices'] as List<dynamic>).map((e) => DeviceDto.fromJson(e as Map<String, dynamic>)).toSet(),
    systems: (json['systems'] as List<dynamic>).map((e) => SystemDto.fromJson(e as Map<String, dynamic>)).toSet(),
