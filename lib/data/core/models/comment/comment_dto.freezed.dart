...
// ignore: unused_element
  _CommentDto call({@required int id, @required UserDto poster, @required String content, @required String creationDate, @required String modificationDate}) {
    return _CommentDto(
      id: id,
      poster: poster,
      content: content,
...
class _$_CommentDto extends _CommentDto {
  ...
  @override
  String toString() {
    return 'CommentDto(id: $id, poster: $poster, content: $content, creationDate: $creationDate, modificationDate: $modificationDate)';
  }
