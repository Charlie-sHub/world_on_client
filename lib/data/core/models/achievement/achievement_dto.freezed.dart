...
abstract class $AchievementDtoCopyWith<$Res> {
  ...
  $Res call(
      {int id, String name, String description, String imageURL, String type, int requisite, int experiencePoints, UserDto creator, String creationDate, String modificationDate, List<TagDto> tags});
}
...
class _$AchievementDtoCopyWithImpl<$Res> implements $AchievementDtoCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      tags: tags == freezed ? _value.tags : tags as List<TagDto>,
    ));
  }
}
...
abstract class _AchievementDto extends AchievementDto {
  ...
  const factory _AchievementDto(
      ...
      @required String creationDate,
      @required String modificationDate,
      @required List<TagDto> tags}) = _$_AchievementDto;
