...
class CloudStorageService {
  ...
  Future<String> uploadFileImage({@required File imageToUpload, @required String name, @required StorageFolder folder}) async {
  ...
  Future<String> uploadAssetImage({@required Asset imageToUpload, @required String name, @required StorageFolder folder}) async {
    final _firebaseStorageReference = _storageInstance.ref().child(folder.value()).child(name);
