...
Experience getValidExperience() => Experience.empty().copyWith(
      id: UniqueId(),
      ...
      objectives: ObjectiveList(
        KtList.of(
          ...
          getValidObjective().copyWith(
            id: UniqueId(),
            description: EntityDescription(
              "Yard sale poaching cork afterbang giblets stomp saddle.",
            ),
            coordinates: Coordinates(
...
Chillax gapers Whistler skid.""",
      ...
      comments: {
        ...
        getValidComment().copyWith(
          id: UniqueId(),
          content: CommentContent(
            "Typewriter plaid fam squid yuccie cloud bread street art.",
          ),
        ),
      },
      likedBy: {UniqueId()},
