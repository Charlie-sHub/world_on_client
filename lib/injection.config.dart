...
GetIt $initGetIt(
  ...
  gh.lazySingleton<BuyCoins>(() => BuyCoins(get<StoreRepositoryInterface>()), registerFor: {_dev, _prod});
  ...
  gh.lazySingleton<DeleteTag>(() => DeleteTag(get<TagManagementRepositoryInterface>()),
