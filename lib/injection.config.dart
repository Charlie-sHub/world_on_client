...
import 'domain/achievement_management/use_case/watch_user_achievements.dart';
...
import 'domain/profile/use_case/watch_user_achievements.dart' as worldon;
...
GetIt $initGetIt(
  ...
  gh.lazySingleton<worldon.WatchUserAchievements>(() => worldon.WatchUserAchievements(get<ProfileRepositoryInterface>()), registerFor: {_dev, _prod});
  gh.lazySingleton<worldon.WatchUserAchievements>(() => MockLoadUserAchievements(), registerFor: {_test});
  gh.lazySingleton<WatchUserAchievements>(() => WatchUserAchievements(get<AchievementRepositoryInterface>()), registerFor: {_dev, _prod});
  gh.lazySingleton<WatchUserAchievements>(() => MockGetUserAchievements(), registerFor: {_test});
