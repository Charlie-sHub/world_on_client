...
import 'application/tag_management/tag_management_watcher/tag_management_watcher_bloc.dart'
    as _i191;
import 'core/modules/flutter_local_notifications_injectable_module.dart' as _i243;
...
import 'data/store/repository/production_store_repository.dart' as _i177;
import 'data/tag_management/repository/development_tag_management_repository.dart' as _i188;
import 'data/tag_management/repository/development_tag_repository.dart' as _i182;
import 'data/tag_management/repository/production_tag_management_repository.dart' as _i190;
import 'data/tag_management/repository/production_tag_repository.dart' as _i183;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i75.ExperienceNavigationRepositoryInterface>(
      () => _i76.DevelopmentExperienceNavigationRepository(),
      registerFor: {_dev});
  gh.lazySingleton<_i75.ExperienceNavigationRepositoryInterface>(
  ...
  gh.lazySingleton<_i176.StoreRepositoryInterface>(
      () => _i177.ProductionStoreRepository(get<_i81.FirebaseFirestore>(), get<_i111.Logger>()),
      registerFor: {_prod});
  gh.lazySingleton<_i176.StoreRepositoryInterface>(() => _i178.MockStoreRepository(),
      registerFor: {_test});
  gh.lazySingleton<_i176.StoreRepositoryInterface>(() => _i179.DevelopmentStoreRepository(),
      registerFor: {_dev});
  gh.factory<_i180.TagCardActorBloc>(() => _i180.TagCardActorBloc());
  gh.lazySingleton<_i181.TagCoreRepositoryInterface>(() => _i182.DevelopmentTagRepository(),
      registerFor: {_dev});
  gh.lazySingleton<_i181.TagCoreRepositoryInterface>(
      () => _i183.ProductionTagRepository(get<_i81.FirebaseFirestore>(), get<_i111.Logger>()),
      registerFor: {_prod});
  gh.lazySingleton<_i181.TagCoreRepositoryInterface>(() => _i184.MockTagRepository(),
      registerFor: {_test});
  ...
  gh.lazySingleton<_i193.UnAccomplishObjective>(
      () => _i193.UnAccomplishObjective(get<_i75.ExperienceNavigationRepositoryInterface>()),
      registerFor: {_dev, _prod});
  ...
  gh.lazySingleton<_i217.WatchRecommendedExperiences>(
      () => _i217.WatchRecommendedExperiences(get<_i75.ExperienceNavigationRepositoryInterface>()),
      registerFor: {_dev, _prod});
  ...
  gh.lazySingleton<_i228.WatchUserLog>(
      () => _i228.WatchUserLog(get<_i66.ExperienceLogRepositoryInterface>()),
      registerFor: {_dev, _prod});
  gh.lazySingleton<_i229.AccomplishObjective>(
      () => _i229.AccomplishObjective(get<_i75.ExperienceNavigationRepositoryInterface>()),
      registerFor: {_dev, _prod});
  ...
  gh.lazySingleton<_i12.AddTagToInterests>(
      ...
      registerFor: {_dev, _prod});
  gh.lazySingleton<_i16.AuthenticationRepositoryInterface>(
      () => _i230.ProductionAuthenticationRepository(get<_i80.FirebaseAuth>(),
          get<_i97.GoogleSignIn>(), get<_i81.FirebaseFirestore>(), get<_i111.Logger>()),
      registerFor: {_prod});
  ...
  gh.lazySingleton<_i33.CommentRepositoryInterface>(
      () => _i234.ProductionCommentRepository(get<_i81.FirebaseFirestore>(), get<_i111.Logger>()),
      registerFor: {_prod});
  gh.lazySingleton<_i37.CoreRepositoryInterface>(
      () => _i235.ProductionCoreRepository(get<_i81.FirebaseFirestore>(), get<_i111.Logger>()),
      registerFor: {_prod});
...
class _$FlutterLocalNotificationsInjectableModule
    extends _i243.FlutterLocalNotificationsInjectableModule {}
