...
import 'domain/profile/use_case/follows_user.dart';
...
GetIt $initGetIt(
  ...
  gh.lazySingleton<FollowsUser>(() => MockFollowsUser(), registerFor: {_test});
  ...
  gh.lazySingleton<FollowsUser>(() => FollowsUser(get<ProfileRepositoryInterface>()), registerFor: {_dev, _prod});
