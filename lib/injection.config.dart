...
import 'data/authentication/repository/development_authentication_repository.dart' as _i18;
...
import 'data/core/repository/production_geo_location_repository.dart' as _i241;
...
import 'data/tag_management/repository/development_tag_repository.dart' as _i185;
import 'data/tag_management/repository/production_tag_management_repository.dart' as _i189;
...
import 'domain/search/repository/search_repository_mock.dart' as _i168;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i16.AuthenticationRepositoryInterface>(
      () => _i17.MockAuthenticationRepository(),
      registerFor: {_test});
  gh.lazySingleton<_i16.AuthenticationRepositoryInterface>(
      () => _i18.DevelopmentAuthenticationRepository(),
      registerFor: {_dev});
  ...
  gh.lazySingleton<_i113.MainFeedRepositoryInterface>(
      () => _i115.ProductionMainFeedRepository(get<_i83.FirebaseFirestore>(), get<_i112.Logger>()),
      registerFor: {_prod});
  gh.lazySingleton<_i113.MainFeedRepositoryInterface>(() => _i116.DevelopmentMainFeedRepository(),
      registerFor: {_dev});
  ...
  gh.lazySingleton<_i150.RemoteOptionsRepositoryInterface>(
      () => _i151.DevelopmentRemoteOptionsRepository(),
      registerFor: {_dev});
  gh.lazySingleton<_i150.RemoteOptionsRepositoryInterface>(
  ...
  gh.lazySingleton<_i165.SearchRepositoryInterface>(
      () => _i167.ProductionSearchRepository(get<_i83.FirebaseFirestore>(), get<_i112.Logger>()),
      registerFor: {_prod});
  gh.lazySingleton<_i165.SearchRepositoryInterface>(() => _i168.MockSearchRepository(),
      registerFor: {_test});
  ...
  gh.lazySingleton<_i177.StoreRepositoryInterface>(() => _i178.MockStoreRepository(),
      registerFor: {_test});
  ...
  gh.lazySingleton<_i177.StoreRepositoryInterface>(
      () => _i180.ProductionStoreRepository(get<_i83.FirebaseFirestore>(), get<_i112.Logger>()),
      registerFor: {_prod});
  gh.factory<_i181.TagCardActorBloc>(() => _i181.TagCardActorBloc());
  gh.lazySingleton<_i182.TagCoreRepositoryInterface>(() => _i183.MockTagRepository(),
      registerFor: {_test});
  gh.lazySingleton<_i182.TagCoreRepositoryInterface>(
      () => _i184.ProductionTagRepository(get<_i83.FirebaseFirestore>(), get<_i112.Logger>()),
      registerFor: {_prod});
  gh.lazySingleton<_i182.TagCoreRepositoryInterface>(() => _i185.DevelopmentTagRepository(),
      registerFor: {_dev});
  ...
  gh.lazySingleton<_i188.TagManagementRepositoryInterface>(
      () => _i189.ProductionTagManagementRepository(
          get<_i83.FirebaseFirestore>(), get<_i112.Logger>()),
      registerFor: {_prod});
  gh.lazySingleton<_i188.TagManagementRepositoryInterface>(
  ...
  gh.lazySingleton<_i87.GeoLocationRepositoryInterface>(
      () => _i240.DevelopmentGeoLocationRepository(get<_i112.Logger>()),
      registerFor: {_dev});
  gh.lazySingleton<_i87.GeoLocationRepositoryInterface>(
      () => _i241.ProductionGeoLocationRepository(get<_i112.Logger>()),
      registerFor: {_prod});
