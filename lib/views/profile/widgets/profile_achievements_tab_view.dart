...
class ProfileAchievementsTabView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => BlocProvider(
        ...
        child: BlocConsumer<ProfileAchievementsWatcherBloc,
            ProfileAchievementsWatcherState>(
          ...
          builder: (context, state) => state.map(
            ...
            loadFailure: (state) => ErrorDisplay(
              retryFunction: () => context
                  .read<ProfileAchievementsWatcherBloc>()
                  .add(
                    ProfileAchievementsWatcherEvent.watchAchievementsStarted(
                      user,
                    ),
                  ),
