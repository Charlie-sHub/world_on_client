...
class TagManagementForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Form(
        autovalidateMode:
            context.read<TagManagementFormBloc>().state.showErrorMessages
        ...
        child: Material(
          ...
          child: TextFormField(
            ...
            validator: (_) =>
                context.read<TagManagementFormBloc>().state.tag.name.value.fold(
                      (failure) => failure.maybeMap(
                        emptyString: (_) =>
                            S.of(context).tagCreationNameEmptyString,
                        multiLineString: (_) =>
                            S.of(context).tagCreationNameMultiLineString,
                        stringExceedsLength: (_) =>
                            S.of(context).tagCreationNameStringExceedsLength,
                        stringWithInvalidCharacters: (_) => S
                            .of(context)
