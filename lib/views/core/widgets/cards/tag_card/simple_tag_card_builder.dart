...
import 'package:worldon/views/core/widgets/cards/tag_card/dislikeable_simple_tag_card.dart';
import 'package:worldon/views/core/widgets/cards/tag_card/likeable_simple_tag_card.dart';
            ...
            loadSuccess: (successState) => BlocProvider(
              ...
              child: BlocBuilder<TagCardActorBloc, TagCardActorState>(
                builder: (context, state) => state.map(
                  initial: (_) => Container(),
                  actionInProgress: (_) =>
                      const WorldOnProgressIndicator(size: 15),
