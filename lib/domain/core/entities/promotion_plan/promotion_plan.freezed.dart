...
class _$PromotionPlanTearOff {
  ...
  _PromotionPlan call({required UniqueId id, required Name name, required EntityDescription description, required PromotionPlanCode code, required int valueInEuros, required DateTime boughtDate}) {
...
abstract class $PromotionPlanCopyWith<$Res> {
  ...
  $Res call({UniqueId id, Name name, EntityDescription description, PromotionPlanCode code, int valueInEuros, DateTime boughtDate});
}
...
class _$_PromotionPlan extends _PromotionPlan {
  const _$_PromotionPlan({required this.id, required this.name, required this.description, required this.code, required this.valueInEuros, required this.boughtDate}) : super._();
  ...
  @override
  String toString() {
    return 'PromotionPlan(id: $id, name: $name, description: $description, code: $code, valueInEuros: $valueInEuros, boughtDate: $boughtDate)';
  }
