...
class _$SystemTearOff {
  ...
  _System call({@required int id, @required String name, @required String type, @required String company}) {
    return _System(
      id: id,
      name: name,
      type: type,
...
abstract class _System implements System {
  const factory _System({@required int id, @required String name, @required String type, @required String company}) = _$_System;
