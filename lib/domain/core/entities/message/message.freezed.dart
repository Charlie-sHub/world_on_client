...
class _$MessageTearOff {
  ...
  _Message call({@required int id, @required User sender, @required User receiver, @required MessageContent content, @required PastDate creationDate}) {
    return _Message(
      id: id,
      sender: sender,
      receiver: receiver,
...
abstract class _Message implements Message {
  const factory _Message({@required int id, @required User sender, @required User receiver, @required MessageContent content, @required PastDate creationDate}) = _$_Message;
