...
abstract class $ProfileDomainFailureCopyWith<T, $Res> {
  factory $ProfileDomainFailureCopyWith(
          ProfileDomainFailure<T> value, $Res Function(ProfileDomainFailure<T>) then) =
...
class _$FollowItself<T> implements FollowItself<T> {
  ...
  @override
  String toString() {
    return 'ProfileDomainFailure<$T>.followItself()';
  }
...
abstract class FollowItself<T> implements ProfileDomainFailure<T> {
...
abstract class BlockItself<T> implements ProfileDomainFailure<T> {
  const factory BlockItself() = _$BlockItself<T>;
}
