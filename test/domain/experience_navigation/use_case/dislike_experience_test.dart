...
void main() {
  ...
  test(
    ...
    () async {
      // Arrange
      when(mockExperienceNavigationRepository.dislikeExperience(any)).thenAnswer((_) async => right(unit));
      // Act
    ...
    () {
      test(
        ...
        () async {
          ...
          when(mockExperienceNavigationRepository.dislikeExperience(any)).thenAnswer((_) async => left(failure));
          // Act
          final result = await useCase(params);
          // Assert
...
void _verifyInteractions(ExperienceNavigationRepositoryInterface mockExperienceNavigationRepository) {
  verify(mockExperienceNavigationRepository.dislikeExperience(any));
