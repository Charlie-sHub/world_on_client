...
void main() {
  ...
  WatchSearchExperiencesByName useCase;
  setUpAll(
    () {
      configureDependencies(injectable.Environment.test);
      mockSearchRepository = getIt<SearchRepositoryInterface>();
      useCase = WatchSearchExperiencesByName(mockSearchRepository);
    },
  );
...
Future<Either<Failure, KtList<Experience>>> _act(WatchSearchExperiencesByName useCase, Params params) async {
