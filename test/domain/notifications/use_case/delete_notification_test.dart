...
void main() {
  ...
  test(
    ...
    () async {
      // Arrange
      when(mockNotificationRepository.deleteNotification(any)).thenAnswer((_) async => right(unit));
      // Act
    ...
    () {
      test(
        ...
        () async {
          ...
          when(mockNotificationRepository.deleteNotification(any)).thenAnswer((_) async => left(failure));
          // Act
          final result = await useCase(params);
          // Assert
...
void _verifyInteractions(NotificationRepositoryInterface mockNotificationRepository) {
  verify(mockNotificationRepository.deleteNotification(any));
